...
assert_line_count 2 "      prometheus/internal:"
assert_line_count 2 "      telemetry:"
assert_line_count 2 "                    port: 8888"
assert_contains "receivers: [prometheus/internal, hostmetrics, kubeletstats]"
